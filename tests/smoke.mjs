...
assert.match(html, /\.song-sect\.chord-picker-open \.sect-lead\{margin-top:var\(--chord-picker-space,190px\)/);
assert.match(html, /const chordOwner=wrap\.closest\('\.song-sect \.sect-chords'\)/);
